...
Limitation rules:
- Extract limitations from sections headed Limitations, Discussion, Conclusion, Future Work, Threats to Validity, Challenges, Open Problems, Perspectives, or equivalent.
...
4. Extract limitations from Limitations, Discussion, Conclusion, Future Work, Threats to Validity, Challenges, Open Problems, Perspectives, or equivalent sections. If none are present, extract them from the general paper context if explicitly stated.
...
LIMITATIONS FILTER:
- Extract explicit caveats from limitations/discussion/conclusion/future-work/challenges/open-problems/perspectives context. If none are present, you may extract explicit caveats from the general paper context.
...
6. Limitations must be explicit caveats/assumptions/metric warnings/future-or-further-research items from limitations/discussion/conclusion/future-work/challenges/open-problems/perspectives context; otherwise use [].
